...
export function JoinUsSection() {
  const formConfig: FormConfig = {
    id: "join-us-form",
    fields: ["fullName", "phoneNumber", "address", "hometown"],
  ...
  return (
    ...
    >
      ...
      <h1 className="text-primary mb-12 px-3 relative text-center z-1">
        Join us
      </h1>
      <FlexBox
        firstColWidth="50"
        secondColWidth="50"
        className="px-18 gap-14 z-1 relative"
      >
        ...
        <div className="right-container">
          <h4 className="font-semibold mb-3">
            આગામી ઇવેન્ટ અથવા મીટિંગ વિશે વિગતો
          </h4>
          <p className="mb-3">
